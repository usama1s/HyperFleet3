...
@section('breadcrumb')
    <ol class="breadcrumb float-sm-right">
        ...
        <li class="breadcrumb-item"><a href="{{ route('booking-agent.index') }}">Booking Agents </a></li>
...
@section('content')
    <div class="container">
        <form method="POST" action="{{ route('booking-agent.store') }}" enctype="multipart/form-data">
            @csrf
                            ...
                            <div class="row vehicle_row even">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input type="file" name="agreement" class="form-control @error('agreement') is-invalid @enderror" value="{{ old('agreement') }}" id="agreement" placeholder="Agreement">
                                        @error('agreement')
                                            <div class="invalid-feedback" style="display:block;" role="alert">
                                                <strong>{{ $message }}</strong>
                                            </div>
                            ...
                            <div class="row vehicle_row odd">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control @error('contact_person') is-invalid @enderror" type="text" name="contact_person" value="{{ old('contact_person') }}" id="contact_person" placeholder="Contact Person">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <select name="payment_terms" id="payment_terms" class="form-control">
                                            <option value="" selected>Select Payment Method</option>
                                            <option value="7/1"  {{ (old('payment_terms') == '7/1') ? 'selected' : ''}}>Weekly&nbsp;7/1</option>
                                            <option value="15/1" {{ (old('payment_terms') == '15/1') ? 'selected' : ''}}>Biweekly&nbsp;15/1</option>
                                            <option value="30/1" {{ (old('payment_terms') == '30/1') ? 'selected' : ''}}>Monthly&nbsp;30/1</option>
                                        </select>
                                        @error('payment_terms')
                                            <div class="invalid-feedback" style="display:block;" role="alert">
                                                <strong>{{ $message }}</strong>
