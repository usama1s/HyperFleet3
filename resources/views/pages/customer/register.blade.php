...
<body>
    ...
    <div class="container">
        <div class="row col-md-6">
            ...
            <a href="" class="btn btn-lg btn-info">Register</a>
        </div>
                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('customer.store') }}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6">
                                    <input id="first_name" type="text" class="form-control @error('first_name') is-invalid @enderror" name="first_name" value="{{ old('first_name') }}" required autocomplete="fname" autofocus>
