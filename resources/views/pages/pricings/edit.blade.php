...
<div class="container">
  ...
  <form method="POST" action="{{route('pricings.update',$pricing->id)}}" enctype="multipart/form-data">
    @method('put')
    @csrf
      ...
      <div class="col-md-12">
        ...
        <div class="card card-default">
          <div class="card-header">
            <h3 class="card-title">Update Pricing Scheme</h3>
...
<!--               <h5>BASE</h5>  -->
                ...
                <div class="form-group">
                  <label>Name</label>
                  <input class="form-control @error('pricing_name') is-invalid @enderror" type="text" name="pricing_name" value="{{ $pricing->title }}"
                    id="pricing_name" required>
                  ...
                  @enderror
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('pickup_point') is-invalid @enderror" type="text"
                            name="pickup_point"  value="{{ $pricing->base_point }}" id="pickup_point" required>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control @error('pickup_radius') is-invalid @enderror" type="number"
                            name="pickup_radius" value="{{ $pricing->start_radius ?? '0.5' }}" step=".1" id="pickup_radius" required>
...
<!--               
 ...
 <div style="padding:8px;min-height:120px;visibility:hidden;" class="col-md-7" id="map"></div>
            ...
            <div class="row">              
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control @error('upto_ten') is-invalid @enderror" type="text" name="upto_ten" value="{{ $pricing->up_to_ten }}"
                    id="upto_ten" required>
              ...
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control @error('ten_to_hundred') is-invalid @enderror" type="text" name="ten_to_hundred" value="{{ $pricing->ten_to_hundred }}"
                    id="ten_to_hundred" required>
            ...
            <div class="row">              
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control @error('hundred_to_twoHundred') is-invalid @enderror" type="text" name="hundred_to_twoHundred" value="{{ $pricing->hundred_to_twoHundred }}"
                    id="hundred_to_twoHundred" required>
                ...
                <div class="col-md-6">
                  <div class="form-group">
                    ...
                    <input class="form-control @error('twoHundred_and_above') is-invalid @enderror" type="text" name="twoHundred_and_above" value="{{ $pricing->twoHundred_and_above }}"
                      id="twoHundred_and_above" required>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control @error('price_per_hour') is-invalid @enderror" type="text" name="price_per_hour" value="{{ $pricing->price_per_hour }}"
                    id="price_per_hour"  required>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control @error('price_per_day') is-invalid @enderror" type="text" name="price_per_day" value="{{ $pricing->price_per_day }}"
                ...
                <div class="form-group">
                  ...
                  <select class="form-control minimum_hours" name="minimum_hours" id="minimum_hours"
                    class="height:50px" required>
                      <option value="1" {{$pricing->minimum_hours  == 1 ? 'selected' : ''}}>1</option>
                      <option value="2" {{$pricing->minimum_hours  == 2 ? 'selected' : ''}}>2</option>
                      <option value="3" {{$pricing->minimum_hours  == 3 ? 'selected' : ''}}>3</option>
                      <option value="4" {{$pricing->minimum_hours  == 4 ? 'selected' : ''}}>4</option>
                  </select>
            ...
            <div class="row">
              <div class="col-md-4">
                <div class="form-group">
                  <label>Additional pick up fee per pickup</label>
                  <input class="form-control @error('pickup_fee_per_pickup') is-invalid @enderror" type="text" name="pickup_fee_per_pickup" value="{{ $pricing->pickup_fee_per_pickup }}"
                    id="pickup_fee_per_pickup" required>
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control @error('waiting_time_per_min') is-invalid @enderror" type="text" name="waiting_time_per_min" value="{{ $pricing->waiting_time_per_min }}"
                    id="waiting_time_per_min" required >
              ...
              <div class="col-md-4">
                <div class="form-group">
                  ...
                  <input class="form-control @error('airport_pickup_fee') is-invalid @enderror" type="text" name="airport_pickup_fee" value="{{ $pricing->airport_pickup_fee }}"
                    id="airport_pickup_fee" required>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  ...
                  <input class="form-control @error('job_discount') is-invalid @enderror" type="text" name="job_discount" value="{{ $pricing->job_discount }}"
                    id="job_discount" required>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="d-flex justify-content-end" style="margin: 50px 20px;">
                  <input class="btn btn-lg btn-success" type="submit" value="Update" style="width:200px">
                </div>
              </div>
            </div>
          </div>
