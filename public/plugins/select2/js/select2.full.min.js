	...
	var e = function() {
			...
			return e && e.requirejs || (e ? n = e : e = {}, m = {}, v = {}, y = {}, _ = {}, r = Object.prototype.hasOwnProperty, a = [].slice, w = /\.js$/, f = function(e, t) {
				...
				return e.prototype.render = function(e) {
					var t = i(`<li class="select2-search select2-search--inline"><input class="select2-search__field"  type="search" tabindex="-1" autocomplete="off" autocorrect="off" autocapitalize="none" spellcheck="false" role="searchbox" aria-autocomplete="list" onkeydown="" /></li>`);
					...
					e.call(this, t, n), t.on("open", function() {
						...
						if (e.stopPropagation(), i.trigger("keypress", e), i._keyUpPrevented = e.isDefaultPrevented(), e.which === l.BACKSPACE && "" === i.$search.val()) {
							...
							if (0 < t.length) {
								...
								var k_var = n;
								k_var.text = $(t[0]).children('div').first().text();
								
								i.searchRemoveChoice(k_var), e.preventDefault()
